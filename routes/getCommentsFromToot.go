...
/*GetCommentsFromToot read the comments from a provided toot*/
func GetCommentsFromToot(w http.ResponseWriter, r *http.Request) {
	...
	page2 := int64(page1)
	answer, correct := database.GetCommentsFromToot(UserID, ID, page2)
	if !correct {
