...
/*GetReloads used to get the date from where gets the notifications and publications.*/
func GetReloads(w http.ResponseWriter, r *http.Request) {
	...
	json.NewEncoder(w).Encode(answer.UpdateDateToday)
}
